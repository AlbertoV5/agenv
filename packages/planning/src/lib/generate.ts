 ...
 *
 * Reference is TRANSFORMATIVE, not accumulative like the checklist.
 * - Can contain initial expectations during planning (high-level logic/content)
 * - Agent rewrites it during/after implementation to reflect actual state
 * - Checklist is the log of what was done; reference describes what exists now
 */
function generateReference(args: GeneratePlanArgs): string {
  ...
  const docsNote =
    args.size === "long"
      ? "<!-- Add ### subsections or links to other .md files in this directory -->"
      : "<!-- Add ### subsections with key file paths and their purposes -->"
  ...
  return [
    ...
    "",
    "<!--",
    "  TRANSFORMATIVE: Fill with expectations during planning, then rewrite",
    "  during/after implementation to describe what actually exists.",
    "  (Checklist is the log; reference describes current state.)",
    "-->",
    "",
    "## Overview",
    "",
    ...
    "## Lessons Learned",
    "",
    "<!-- Insights and considerations for future work -->",
    "",
    "---",
    "",
    `*Last updated: ${now}*`,
