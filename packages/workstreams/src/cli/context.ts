 ...
 * (Previously 'work continue', renamed to avoid confusion with 'work multi --continue')
 */
...
function parseCliArgs(argv: string[]): ContextCliArgs | null {
    const args = argv.slice(2)
    const parsed: Partial<ContextCliArgs> = {}
    ...
    return parsed as ContextCliArgs
}
