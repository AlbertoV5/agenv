...
function generateAgentsYaml(config) {
...
function saveAgentsConfigYaml(repoRoot, config) {
  const path = getAgentsYamlPath(repoRoot);
...
function listAgentsYaml(config) {
...
function getPrimaryModel(config, agentName) {
...
function listSynthesisAgents(config) {
